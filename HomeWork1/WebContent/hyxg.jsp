   ...
   <div class="admin-index">
    ...
    <div class="admin-biaoge">
      ...
      <table class="am-table">
        ...
        <tbody>
          <tr>
            <td><input  type="hidden" name="id" value="${ch.id } " ></td>
            <td><input class="a" type="text" name="password" value="${ch.password }"></td>
            <td><input class="b" type="text" name="username" value="${ch.username }"></td>
            <td><input class="b" type="text" name="je" value= "${ch.je }"></td>
            <td><input class="b" type="text" name="kye" value="${ch.kye }"></td>
            <td><input class="b" type="text" name="kind" value="${ch.kind }"></td>
