   ...
   <div class="admin-index">
    ...
    <div class="admin-biaoge">
      ...
      <table class="am-table">
       ...
       <form action="BookServlet?flag=add" method="post" enctype="multipart/form-data">
        <tbody>
          <tr>
            <td><input class="b" type="text" name="name"></td>
            <td><input class="b" type="text" name="price"></td>
            <td><input class="b" type="file" name="img"></td>
            <td><input class="b" type="text" name="writer"></td>
            <td><input class="b" type="submit" value="添加"></td>
          </tr>
       </form> 
        </tbody>
      </table>
