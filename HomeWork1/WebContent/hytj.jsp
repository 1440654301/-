   ...
   <div class="admin-index">
    ...
    <div class="admin-biaoge">
      ...
      <table class="am-table">
        ...
        <tbody>
          <tr>
            <td><input class="a" type="text" name="password"></td>
            <td><input class="b" type="text" name="username"></td>
            <td><input class="b" type="text" name="je"></td>
            <td><input class="b" type="text" name="kye"></td>
            <td><input class="b" type="text" name="kind"></td>
