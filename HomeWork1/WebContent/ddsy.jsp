...
<div class="admin">
   ...
   <div class="admin-index">
    ...
    <div class="admin-biaoge">
      ...
      <!-- <form action="ddServlet?flag=findAll" method="post"> -->
      <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped am-table-hover">
            <thead>
              <tr class="am-success">
                ...
                <th class="table-type">书籍详情</th>
                <th class="table-author am-hide-sm-only">付款方式</th>
                <th class="table-author am-hide-sm-only">附加信息</th>
                <th width="130px" class="table-set">操作</th>
              </tr>
            </thead>
            
            <tbody >
            <c:forEach items="${che }" var="a" varStatus="s">
             <!--  <from action="ddServlet?flag=" method="post"> -->
              <tr>
	           ...
	           <td>${a.xx }</td>
                <td>
                    ...
                    <div class="am-btn-group am-btn-group-xs">
                     <a href="ddServlet?flag=yupdate&number=${a.number}" class="am-btn am-btn-default am-btn-xs am-text-secondary am-round" data-am-modal="{target: '#my-popups'}" title="修改订单"><span class="am-icon-pencil-square-o">
                       </span></a>
                     <a href="ddServlet?flag=delete&number=${a.number}" class="am-btn am-btn-default am-btn-xs am-text-danger am-round" title="删除订单" >
