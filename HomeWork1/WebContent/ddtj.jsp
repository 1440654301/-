...
<div class="admin">
   ...
   <div class="admin-index">
    ...
    <div class="admin-biaoge">
      ...
      <form action="ddServlet?flag=add"  method="post">
      <table class="am-table">
        ...
        <tbody>
          <tr>
            <td><input class="a" type="text" name="number"></td>
            <td><input class="b" type="text" name="price"></td>
            <td><input class="b" type="text" name="xq"></td>
            <td><input class="b" type="text" name="ff"></td>
            <td><input class="b" type="text" name="xx"></td>
            <td><input class="b" type="submit" value="增加"/></td>
          </tr>
        </tbody>
      </table>
      </form>
