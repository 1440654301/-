   ...
   <div class="admin-index">
    ...
    <div class="admin-biaoge">
      ...
      <table class="am-table">
       ...
       <form action="BookServlet?flag=update" method="post"  enctype="multipart/form-data">
        <tbody>
          <tr>
            <td><input class="b" type="hidden" name="id" value=${updatebook.id }></td>
            <td><input class="b" type="text" name="name" value=${updatebook.name }></td>
            <td><input class="b" type="text" name="price" value=${updatebook.price }></td>
            <td><input class="b" type="file" name="img" value=${updatebook.img }></td>
            <td><input class="b" type="text" name="writer" value=${updatebook.writer }></td>
