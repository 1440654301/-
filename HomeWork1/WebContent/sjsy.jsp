...
<header class="am-topbar admin-header">
 ...
 <li class="soso">
 <form action="BookServlet?flag=findByName" method="post">
<p class="ycfg"><input type="text" name="name" class="am-form-field am-input-sm" placeholder="搜索书名或作者" /></p>
      ...
      <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped am-table-hover">
            <thead>
              <tr class="am-success">
                ...
                <th class="table-type">书籍价格</th>
                <th class="table-author am-hide-sm-only">书籍封面</th>
                <th class="table-author am-hide-sm-only">书籍作者</th>
                <th width="130px" class="table-set">操作</th>
              </tr>
            </thead>
            <tbody>
            <c:forEach items="${books }" var="a" varStatus="s">
              <tr>
                <td><input type="checkbox" /></td>
                <td>${a.id}</td>
                <td>${a.name}</td>
                <td>${a.price}</td>
                <td><img src="/book/${a.img }" width="40" height="30"></td>
                <td>${a.writer}</td>
                <td>
                	<div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                     <a href="BookServlet?flag=yupdate&id=${a.id}" class="am-btn am-btn-default am-btn-xs am-text-secondary am-round" data-am-modal="{target: '#my-popups'}" title="修改订单"><span class="am-icon-pencil-square-o">
                       </span></a>
                     <a href="BookServlet?flag=delete&id=${a.id}" class="am-btn am-btn-default am-btn-xs am-text-danger am-round" title="删除订单" >
